\begin{tikzpicture}
	...
	\node[right=1cm of n3.east, anchor=west] (b3) {
		\tcbox[title=AttOmics]{
			...
			Group are individually projected to enrich their representation with intra-group interactions.
			\Glsxtrshort{mhsa} is the applied on the set of groups to incorporate inter-group interactions in the representation.
