 ...
 \begin{landscape}
     \section{Supplementary tables}
      \subsection{Models performances on various combinations of omics on TCGA dataset}
          \input{tables/table_AttOmics_omics_comb}
          \input{tables/table_AttOmicsEarlyFusion_omics_comb}
          \input{tables/table_AttOmicsIntermediateFusion_omics_comb}
          \input{tables/table_CrossAttOmics_omics_comb}
          \input{tables/table_GraphClassifier_omics_comb}
          \input{tables/table_GraphClassifierEarlyFusion_omics_comb}
          \input{tables/table_MLP_omics_comb}
          \input{tables/table_MLPEarlyFusion_omics_comb}
          \input{tables/table_MLPIntermediateFusion_omics_comb}
          \input{tables/table_MOGONET_omics_comb}
          \input{tables/table_PNet_omics_comb}
      \subsection{Models performances on various combinations of omics on CCLE dataset}
          \input{tables/table_AttOmics_omics_comb_ccle}
          \input{tables/table_AttOmics EF_omics_comb_ccle}
          \input{tables/table_AttOmics IF_omics_comb_ccle}
          \input{tables/table_CrossAttOmics_omics_comb_ccle}
          \input{tables/table_MLP_omics_comb_ccle}
          \input{tables/table_MLP EF_omics_comb_ccle}
          \input{tables/table_MLP IF_omics_comb_ccle}
          \input{tables/table_MOGONET_omics_comb_ccle}
 \end{landscape}