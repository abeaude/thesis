...
\section{Results}
	...
	\subsection{Comparison with state of the art}
		...
		\begin{figure}[htbp]
			...
			\end{subcaptiongroup}
			\caption{Error rate on the test set according to the size of the training set for three different omics: DNAm~\subref{fig:limit_train_classif_A}, mRNA~\subref{fig:limit_train_classif_B}, miRNA~\subref{fig:limit_train_classif_C}.}\label{fig:limit_train_classif}
		\end{figure}
