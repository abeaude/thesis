...
\section{Experiments}
	\subsection{Data}
		...
		This dataset is used to perform two predicting tasks: phenotype prediction, 19 different cancers and normal (healthy), and survival risk prediction.
		A total of 8777 patients were available for the phenotype prediction and 8349 patients for the survival risk prediction.
		We used a train/validation/test (70/15/15\%) splits strategy preserving the cancer proportion to evaluate the different considered models.
