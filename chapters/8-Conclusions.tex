...
% 	centered tabularray={
% 		colspec={S[table-format=2.2]S[table-format=2.2]S[table-format=2.2]S[table-format=2.2]S[table-format=2.2]S[table-format=2.2]}
% 		}
% 		]{temp.csv}{}{}
\csvautotabularray[respect backslash=false, respect leftbrace=false, respect rightbrace=false]{temp.csv}
\end{document}
