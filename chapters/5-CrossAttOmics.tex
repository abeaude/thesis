...
\section{Experiments}
 \subsection{Data}
     ...
     \begin{figure}[htbp]
         ...
         \centering
         \begin{tikzpicture}
             \clip (-2.5, -1.75) rectangle (2.5,0.4);
             \node (DNAm) at (-1.5,0.3) {DNAm};
             \node (miRNA) at (-1.5,-0.5) {miRNA};
             \node (CNV) at (0,0) {CNV};
             \node (nc mRNA) at (1.5,-0.5) {nc mRNA};
             \node (mRNA) at (0,-1) {mRNA};
             \node (Proteins) at (0,-1.65) {Proteins};
