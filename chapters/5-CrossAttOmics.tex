...
\section{Results}
	...
	\subsection{Omics combination}
		...
		\begin{figure}
			...
			\end{subcaptiongroup}
			\caption[UMAP comparison of pan-cancer samples]{UMAP comparison of pan-cancer samples in the data space~\subref{fig:umap_mrna_A}, after passing through the modality encoder~\subref{fig:umap_mrna_B} and after applying the cross-attention~\subref{fig:umap_mrna_C}. Each color represent one of the 18 cancer. }
			\label{fig:umap_mrna}
		\end{figure}
	...
	\subsection{Robustness to missing modality}
		...
		%TODO: better explain this figure, what are we doing, what are we measuring
