...
\section{Prediction from multi-omics data}
	...
	\subsection{Deep learning models for multi-omics data}
		...
		Then, \gls{gcn} are applied on the graph to obtain a new graph representation for \glsxtrshort{ppi}-based approach, and a new node representation for patient-graph approach. 
