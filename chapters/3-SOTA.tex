...
\section{Model interpretability}
	...
	Explainable artificial intelligence or interpretability is a growing field that developed in response to the increasing presence of \textit{black-box} models.
	...
	, many terms used interchangeably: interpretability and explainability
	...
	\cite{clinciu-hastie-2019-survey} compare various definition of the terms
	def often varies according to the researcher or the context

	interpretability defined as the ability to get clear explanation supporting the decision
	how to classify them, multiple classification are possible (cite other surveys)
	how to classify the different methods: passive/Active (post-hoc/self explainable) local global
	attribution/instance based/hidden semantics/rules (cite survey)

	The easiest way to have interpretability is to use interpretable models such as decision tree or linear models.
	also possible with more complex models such as deep learning ones
	...
	However, it is not always possible to use interpretable models.
