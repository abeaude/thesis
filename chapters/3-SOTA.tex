...
\section{Multimodal machine learning}
	...
	\begin{description}[%
	    ...
	    \item[Cross attention]
		    ...
		    Usually, this methods is done in a bidirectional manner resulting in two contextualized representation accounting for the assymetric interactions~\cite{VilBERT}:
		    \begingroup
		    \setlength{\abovedisplayskip}{2pt}
		    \setlength{\belowdisplayskip}{2pt}
		    \setlength{\abovedisplayshortskip}{0pt}
...
\section[Multi-omics integration with ML]{Multi-omics data integration with machine learning methods}
	...
	\end{equation}%todo: cref long name ?
