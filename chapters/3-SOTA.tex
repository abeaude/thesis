...
\section{Prediction from multi-omics data}
	...
	\subsection{Multi-omics data integration}
		...
		By assuming that the factor matrix and the residuals, \(E_i = X_i - W_iH\) are normaly distributed, a multivariate normal log-likelihood can be derived before applying the expectation-maximization algorithm to solve this problem.
		...
		% TODO: add NTF: https://accscience.com/journal/AIH/1/3/10.36922/aih.3427
		% generalization to higher order tensors\footnote{matrices can be seen as second-orders tensors}
		% https://www.plus.ac.at/wp-content/uploads/2021/02/2013-05_Flatz.pdf
