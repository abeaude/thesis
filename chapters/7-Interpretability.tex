...
\section{Preliminary results}
	\subsection{Adversarial study}
		...
		Results for the \gls{mlp} BN model are describe here~(\cref{fig:mlp_bn_adv_tradeoff}), results for the other models  are available in~ \cref{chapinterpretability_appendix} \crefrange{fig:mlp_ln_adv_tradeoff}{fig:mlp_fnagcadv_tradeoff}.
