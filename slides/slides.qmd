...
:::{.callout-important appearance="simple"}
{{< fa circle-exclamation >}} **How to apply self-attention to large large vectors ?**
:::
...
<!-- ![](tcga_perf_omics_comb.svg){fig-align="center"  .r-stretch} -->
...
::: {.fragment .fade-up}
:::{.callout-important appearance="simple"}
{{< fa circle-exclamation >}} **Knowledge is iteratively constructed and omics measurement represent a *mean* of all occuring pathwyays.**
:::
:::
