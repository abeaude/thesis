...
\documentclass[print, english, final]{thesissaclay}
\usepackage{qrcode}
...
\backmatter
% tikzpage
% \cleardoubleevenpage % backcover, add summary ?
% \thispagestyle{empty}
% \makeatletter
% \begin{FlushLeft}
% 	\Large\textbf{\textcolor{Prune}{\@title}}
% 	\vspace{\fill}
% \end{FlushLeft}

% \begin{center}
% 	\begin{minipage}{0.9\textwidth}
% 		\small\input{frontmatter/shortsummaryEN.tex}
% 	\end{minipage}
% \end{center}

% \begin{FlushRight}
% 	\vspace{\fill}
% 	\qrcode[height=2cm]{https://github.com/abeaude/thesis}
% 	\medskip \\ Online version
% \end{FlushRight}
