...
\NewDocumentCommand{\MyrobExtCopyFileToCache}{mm}{
  ...
  \file_if_exist:xTF {\robExtAddCachePath{#2}}{
    ...
    \str_compare:eNeTF {\l_tmpa_str} = {\l_tmpb_str} {
      ...
      \robExtRunCmdIfPossible{\robExtCp \space "#1"~"\robExtAddCachePath{#2}"}%
    }
  }{
...
%\robExtAddCachePathAndName{\robExtFinalHash.tex}
%\typeout
% \robExtWriteFile
%\apptocmd{\robExtWriteFile}{\typeout{\robExtAddCachePathAndName{\robExtFinalHash.tex}}}{Patch robExtWriteFile}{No patch robExtWriteFile}
\cacheTikz
% \ExplSyntaxOn
% \sys_shell_now:x \l__robExt_current_compilation_command_str
% \ExplSyntaxOff
